...
\usepackage[versalete,num,abnt-and-type=e,abnt-etal-list=0,abnt-etal-cite=3]{abntex2/abntex2cite} 
\citebrackets[]
\usepackage{multirow}
...
% \input{pretext/ficha}
% \input{pretext/ata_defesa}
% \input{pretext/folha_aprovacao_original}
% \input{pretext/dedicatoria}
\input{pretext/agradecimentos}
\input{pretext/epigrafe}
\input{pretext/resumo}
