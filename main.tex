...
% ----------------------------------------------------------
\input{document/others/acronimos}
...
% GLOSSÁRIO
% ----------------------------------------------------------
\input{document/others/glossaries}
...
\input{document/others/ficha}
% \input{document/others/ata_defesa}
\input{document/others/folha_aprovacao_original}
\input{document/others/dedicatoria}
\input{document/others/agradecimentos}
\input{document/others/epigrafe}
\input{document/others/resumo}
...
% LISTA DE SIMBOLOS
% ----------------------------------------------------------
\input{document/others/list_simbol}
